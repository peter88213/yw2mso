...
<w:settings xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:zoom w:percent="100"/><w:defaultTabStop w:val="709"/><w:autoHyphenation w:val="true"/><w:compat><w:compatSetting w:name="compatibilityMode" w:uri="http://schemas.microsoft.com/office/word" w:val="15"/></w:compat><w:themeFontLang w:val="" w:eastAsia="" w:bidi=""/></w:settings>'''
    ...
    def _convert_from_yw(self, text, quick=False):
        ...
        DOCX_REPLACEMENTS = [
            ...
            ('>', '&gt;'),
            ('<', '&lt;'),
            ('\n\n', (2 * '</w:t></w:r></w:p><w:p><w:pPr><w:pStyle w:val="BodyText"/><w:rPr></w:rPr></w:pPr><w:r><w:rPr></w:rPr><w:t>')),
            ('\n', '</w:t></w:r></w:p><w:p><w:pPr><w:pStyle w:val="First Line Indent"/><w:rPr></w:rPr></w:pPr><w:r><w:rPr></w:rPr><w:t>'),
            ('\r', '\n'),
            # ('[i]', '</w:t><w:r><w:rPr><w:rStyle w:val="Emphasis"/></w:rPr><w:t>'),
            # ('[/i]', '</w:t></w:r><w:t xml:space="preserve">'),
            # ('[b]', '</w:t><w:r><w:rPr><w:rStyle w:val="Strongemphasis"/></w:rPr><w:t>'),
            # ('[/b]', '</w:t></w:r><w:t xml:space="preserve">'),
            ('/*', '/*'),
            ('*/', '*/'),
        ]
        try:
